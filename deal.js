...
function dealing() {
  ...
  if (
    isNaN(main.tags.bet.value) ||
    main.tags.bet.value == 0 ||
    main.tags.bet.value > main.values.chips ||
    main.tags.bet.value < 0
  ) {
    ...
    setTimeout(function () {
      for (let i = 2; i < 6; i++) {
        ...
        if (j === 0) {
          ...
          main.values.playerValue +=
            main.array.numValue[main.array.num.indexOf(numOnCard)];
          main.tags.pscore.textContent =
            "Player Total: " + main.values.playerValue;
          pCard = numOnCard;
          if (pCard === "A") {
        ...
        // Alternative cards to the dealer.
          ...
          main.values.dealerValue +=
            main.array.numValue[main.array.num.indexOf(numOnCard)];
          main.tags.dscore.textContent =
            "Dealer Total: " + main.values.dealerValue;
...
function hitme() {
  ...
  if (isMobile && main.tags.player.childNodes.length >= 4) {
    let playerNodes = main.tags.player.childNodes;
    playerNodes.forEach((element) => {
